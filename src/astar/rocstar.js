...
import {
    sendExtrinsic, getDecimalBN, listenEvents, readMnemonicFromFile, calculateTimeout, bnToFloat, delay, getHourlyTimestamp,
} from '../common/utils';
...
const main = async () => {
    ...
    const schedule = { Fixed: [timestampNextHour] };
