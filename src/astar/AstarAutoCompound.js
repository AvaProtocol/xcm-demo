...
class AstarAutoCompound {
    constructor(turingConfig, astarConfig) {
        this.turingConfig = turingConfig;
        this.astarConfig = astarConfig;
    }
    ...
    run = async () => {
        ...
        const shibuyaHelper = new ShibuyaHelper(this.astarConfig);
        ...
        const proxyTypeParachain = parachainName === 'shiden' ? 'DappsStaking' : 'Any'; // We cannotset proxyType to "" without the actual auto-restake call
...
export default AstarAutoCompound;
